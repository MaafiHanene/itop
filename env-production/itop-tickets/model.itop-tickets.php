						<?php
//
// File generated by ... on the 2018-09-23T20:48:31+0000
...
define('PORTAL_ALL_PARAMS', 'from_service_id,org_id,caller_id,service_id,servicesubcategory_id,impact,emergency,moreinfo,caller_id,start_date,end_date,duration,impact_duration');
  ...
  array (
    ...
    array (
      ...
      'rejected' => 'closed',
		...
		MetaModel::Init_AddAttribute(new AttributeText("description", array("allowed_values"=>null, "sql"=>'description', "default_value"=>'', "is_null_allowed"=>true, "depends_on"=>array(), "format"=>'html', "always_load_in_tables"=>false)));
