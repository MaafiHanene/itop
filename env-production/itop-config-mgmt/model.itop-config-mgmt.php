						<?php
//
// File generated by ... on the 2018-09-23T20:48:24+0000
...
class NetworkDevice extends DatacenterDevice
{
	public static function Init()
	{
		...
		MetaModel::Init_Params($aParams);
		MetaModel::Init_InheritAttributes();
		MetaModel::Init_AddAttribute(new AttributeExternalKey("networkdevicetype_id", array("targetclass"=>'', "allowed_values"=>null, "sql"=>'networkdevicetype_id', "is_null_allowed"=>true, "on_target_delete"=>DEL_MANUAL, "depends_on"=>array(), "display_style"=>'select', "always_load_in_tables"=>false)));
