...
class __TwigTemplate_2b8cc59ccdc435c99039dfaa7f44ea63d094582894b3445af04685fbba91ed46 extends Twig_Template
{
    ...
    {
        // line 5
        $context["oContactForm"] = $this->getAttribute((isset($context["forms"]) ? $context["forms"] : null), "contact", array());
        // line 6
        $context["oPreferencesForm"] = $this->getAttribute((isset($context["forms"]) ? $context["forms"] : null), "preferences", array());
        // line 7
        $context["oPasswordForm"] = $this->getAttribute((isset($context["forms"]) ? $context["forms"] : null), "password", array());
        // line 3
...
";
    ...
    public function block_pMainContentHolder($context, array $blocks = array())
    {
        // line 16
        echo "\t";
        if ((isset($context["bDemoMode"]) ? $context["bDemoMode"] : null)) {
            // line 17
...
\t\t\t\t\t\t\t<form id=\"";
        // line 32
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["oContactForm"]) ? $context["oContactForm"] : null), "id", array()), "html", null, true);
        echo "\" class=\"\" method=\"POST\" action=\"";
        echo $this->getAttribute($this->getAttribute((isset($context["oContactForm"]) ? $context["oContactForm"] : null), "renderer", array()), "GetEndpoint", array(), "method");
        echo "\">
\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"transaction_id\" value=\"";
        // line 33
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["oContactForm"]) ? $context["oContactForm"] : null), "transaction_id", array()), "html", null, true);
        echo "\" />
...
\t\t\t\t\t\t\t\t\t";
        // line 40
        echo $this->getAttribute($this->getAttribute((isset($context["oContactForm"]) ? $context["oContactForm"] : null), "renderer", array()), "GetBaseLayout", array(), "method");
        echo "
\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t</form>
\t\t\t\t\t\t</div>
...
\t\t\t\t\t";
        // line 47
        if ($this->getAttribute((isset($context["oBrick"]) ? $context["oBrick"] : null), "GetShowPictureForm", array(), "method")) {
            // line 48
            echo "\t\t\t\t\t\t";
        ...
        echo "
            \t\t";
        // line 85
        if ($this->getAttribute((isset($context["oBrick"]) ? $context["oBrick"] : null), "GetShowPreferencesForm", array(), "method")) {
            // line 86
            echo "\t\t\t\t\t\t";
...
\t\t\t\t\t";
        // line 107
        if ($this->getAttribute((isset($context["oBrick"]) ? $context["oBrick"] : null), "GetShowPasswordForm", array(), "method")) {
            // line 108
            echo "\t\t\t\t\t\t";
...
\t\t\t\t\t\t\t\t\t<form id=\"picture-form\" method=\"POST\" action=\"";
        // line 59
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "url_generator", array(), "array"), "generate", array(0 => "p_user_profile_brick"), "method"), "html", null, true);
        echo "\">
...
\t\t\t\t\t\t\t\t\t<form id=\"";
        // line 92
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["oPreferencesForm"]) ? $context["oPreferencesForm"] : null), "id", array()), "html", null, true);
        echo "\" class=\"\" method=\"POST\" action=\"";
        echo $this->getAttribute($this->getAttribute((isset($context["oPreferencesForm"]) ? $context["oPreferencesForm"] : null), "renderer", array()), "GetEndpoint", array(), "method");
        echo "\">
\t\t\t\t\t\t\t\t\t\t<div class=\"form_alerts\">
\t\t\t\t\t\t\t\t\t\t\t<div class=\"alert alert-success\" role=\"alert\" style=\"display: none;\"></div>
\t\t\t\t\t\t\t\t\t\t\t<div class=\"alert alert-warning\" role=\"alert\" style=\"display: none;\"></div>
...
\t\t\t\t\t\t\t\t\t\t\t";
        // line 99
        echo $this->getAttribute($this->getAttribute((isset($context["oPreferencesForm"]) ? $context["oPreferencesForm"] : null), "renderer", array()), "GetBaseLayout", array(), "method");
        echo "
\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t</form>
\t\t\t\t\t\t\t\t</div>
...
\t\t\t\t\t\t\t\t\t";
        // line 114
        if ( !(null === (isset($context["oPasswordForm"]) ? $context["oPasswordForm"] : null))) {
            // line 115
            echo "\t\t\t\t\t\t\t\t\t\t<form id=\"";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["oPasswordForm"]) ? $context["oPasswordForm"] : null), "id", array()), "html", null, true);
            echo "\" class=\"\" method=\"POST\" action=\"";
            echo $this->getAttribute($this->getAttribute((isset($context["oPasswordForm"]) ? $context["oPasswordForm"] : null), "renderer", array()), "GetEndpoint", array(), "method");
...
\t\t\t\t\t\t\t\t\t\t\t\t";
            // line 122
            echo $this->getAttribute($this->getAttribute((isset($context["oPasswordForm"]) ? $context["oPasswordForm"] : null), "renderer", array()), "GetBaseLayout", array(), "method");
            echo "
\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t</form>
\t\t\t\t\t\t\t\t\t";
...
\t\t\t\t\t\t";
        // line 137
        if (((isset($context["sFormMode"]) ? $context["sFormMode"] : null) == twig_constant("\\Combodo\\iTop\\Portal\\Controller\\ObjectController::ENUM_MODE_EDIT"))) {
            // line 138
...
\tvar oContactFormFieldSet = \$('#";
        ...
        echo twig_jsonencode_filter($this->getAttribute((isset($context["oContactForm"]) ? $context["oContactForm"] : null), "fieldset", array()));
        echo ");
\t\$('#";
        // line 152
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["oContactForm"]) ? $context["oContactForm"] : null), "id", array()), "html", null, true);
...
\t\tformmanager_class: \"";
        // line 153
        echo twig_escape_filter($this->env, twig_escape_filter($this->env, $this->getAttribute((isset($context["oContactForm"]) ? $context["oContactForm"] : null), "formmanager_class", array()), "js"), "html", null, true);
        echo "\",
\t\tformmanager_data: ";
        // line 154
        echo twig_jsonencode_filter($this->getAttribute((isset($context["oContactForm"]) ? $context["oContactForm"] : null), "formmanager_data", array()));
        echo ",
...
\tvar oPreferencesFormFieldSet = \$('#";
        ...
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["oPreferencesForm"]) ? $context["oPreferencesForm"] : null), "id", array()), "html", null, true);
        echo " > .form_fields').field_set(";
        echo twig_jsonencode_filter($this->getAttribute((isset($context["oPreferencesForm"]) ? $context["oPreferencesForm"] : null), "fieldset", array()));
        echo ");
\t\$('#";
        // line 161
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["oPreferencesForm"]) ? $context["oPreferencesForm"] : null), "id", array()), "html", null, true);
...
\t\tformmanager_class: \"";
        // line 162
        echo twig_escape_filter($this->env, twig_escape_filter($this->env, $this->getAttribute((isset($context["oPreferencesForm"]) ? $context["oPreferencesForm"] : null), "formmanager_class", array()), "js"), "html", null, true);
        echo "\",
\t\tformmanager_data: ";
        // line 163
        echo twig_jsonencode_filter($this->getAttribute((isset($context["oPreferencesForm"]) ? $context["oPreferencesForm"] : null), "formmanager_data", array()));
        echo ",
...
\t\tvar oPasswordFormFieldSet = \$('#";
            ...
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["oPasswordForm"]) ? $context["oPasswordForm"] : null), "id", array()), "html", null, true);
            echo " > .form_fields').field_set(";
            echo twig_jsonencode_filter($this->getAttribute((isset($context["oPasswordForm"]) ? $context["oPasswordForm"] : null), "fieldset", array()));
            echo ");
\t\t\$('#";
            // line 171
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["oPasswordForm"]) ? $context["oPasswordForm"] : null), "id", array()), "html", null, true);
...
\t\t\tformmanager_class: \"";
            // line 172
            echo twig_escape_filter($this->env, twig_escape_filter($this->env, $this->getAttribute((isset($context["oPasswordForm"]) ? $context["oPasswordForm"] : null), "formmanager_class", array()), "js"), "html", null, true);
            echo "\",
\t\t\tformmanager_data: ";
            // line 173
            echo twig_jsonencode_filter($this->getAttribute((isset($context["oPasswordForm"]) ? $context["oPasswordForm"] : null), "formmanager_data", array()));
            echo ",
...
";
    ...
    {
        return new Twig_Source("", "itop-portal-base/portal/src/views/bricks/user-profile/layout.html.twig", "C:\\wamp64\\www\\itop3\\env-production\\itop-portal-base\\portal\\src\\views\\bricks\\user-profile\\layout.html.twig");
    }
}
