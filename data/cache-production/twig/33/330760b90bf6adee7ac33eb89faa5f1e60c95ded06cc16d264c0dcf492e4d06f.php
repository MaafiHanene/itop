...
class __TwigTemplate_5dbb39caf370878488161edb1924769fac7e11df8c91767fdce8e39375898943 extends Twig_Template
{
    ...
    public function block_pMainContentHolder($context, array $blocks = array())
    {
        // line 8
        echo "    ";
        if ((twig_length_filter($this->env, (isset($context["aGroupingTabsValues"]) ? $context["aGroupingTabsValues"] : null)) > 1)) {
            // line 9
            echo "        <ul class=\"nav nav-pills grouping_tabs\">
            ";
            // line 10
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["aGroupingTabsValues"]) ? $context["aGroupingTabsValues"] : null));
            foreach ($context['_seq'] as $context["_key"] => $context["aGroupingTab"]) {
                // line 11
                echo "                <li";
                if ((array_key_exists("sGroupingTab", $context) && ((isset($context["sGroupingTab"]) ? $context["sGroupingTab"] : null) == $this->getAttribute($context["aGroupingTab"], "value", array())))) {
                    echo " class=\"active\"";
                }
                echo ">
                    <a href=\"";
                // line 12
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "url_generator", array()), "generate", array(0 => "p_manage_brick", 1 => array("sBrickId" => (isset($context["sBrickId"]) ? $context["sBrickId"] : null), "sDisplayMode" => "default", "sGroupingTab" => $this->getAttribute($context["aGroupingTab"], "value", array()))), "method"), "html", null, true);
                echo "\"
                       id=\"btn_tab_for_";
                // line 13
                ...
                echo "
                        ";
                // line 15
                if ($this->getAttribute((isset($context["oBrick"]) ? $context["oBrick"] : null), "GetShowTabCounts", array(), "method")) {
                    // line 16
    ...
    ";
        ...
        // line 24
        echo "    ";
        if ((twig_length_filter($this->env, (isset($context["aGroupingAreasData"]) ? $context["aGroupingAreasData"] : null)) > 0)) {
            // line 25
            echo "        ";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["aGroupingAreasData"]) ? $context["aGroupingAreasData"] : null));
            foreach ($context['_seq'] as $context["_key"] => $context["aAreaData"]) {
                ...
                if (($this->getAttribute($context["aAreaData"], "iItemsCount", array()) > 0)) {
                    // line 27
                    echo "                ";
                    $context["iTableCount"] = ((isset($context["iTableCount"]) ? $context["iTableCount"] : null) + 1);
                    // line 28
                    ...
                    echo "</h3>
                        ";
                    // line 31
                    if ((isset($context["bCanExport"]) ? $context["bCanExport"] : null)) {
                        // line 32
                        echo "                            <a href=\"";
                        echo $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "url_generator", array()), "generate", array(0 => "p_manage_brick_excel_export_start", 1 => array("sBrickId" => (isset($context["sBrickId"]) ? $context["sBrickId"] : null), "sGroupingTab" => (isset($context["sGroupingTab"]) ? $context["sGroupingTab"] : null), "sGroupingArea" => $this->getAttribute($context["aAreaData"], "sId", array()))), "method");
                        echo "\"
    ...
    ";
        // line 50
        if (((isset($context["iTableCount"]) ? $context["iTableCount"] : null) == 0)) {
            // line 51
            echo "        <div class=\"panel panel-default\">
            <div class=\"panel-body\">
    ...
    <script type=\"text/javascript\">
        var sDataLoading = '";
        // line 63
        echo twig_escape_filter($this->env, (isset($context["sDataLoading"]) ? $context["sDataLoading"] : null), "html", null, true);
        echo "';
        ...
        echo "':
                                        url = '";
        // line 128
        echo $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "url_generator", array()), "generate", array(0 => "p_object_view", 1 => array("sObjectClass" => "-objectClass-", "sObjectId" => "-objectId-")), "method");
        ...
        echo "':
                                        url = '";
        // line 131
        echo $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "url_generator", array()), "generate", array(0 => "p_object_edit", 1 => array("sObjectClass" => "-objectClass-", "sObjectId" => "-objectId-")), "method");
        echo "'.replace(/-objectClass-/, itemPrimaryAction.class).replace(/-objectId-/, itemPrimaryAction.id);
                                        break;
                                    default:
                                        url = '#';
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["aAreaData"]) {
            ...
            // line 230
            echo twig_escape_filter($this->env, (isset($context["sAreaId"]) ? $context["sAreaId"] : null), "html", null, true);
            echo "'));
\t\t\tvar oTable";
            // line 231
            echo twig_escape_filter($this->env, (isset($context["sAreaId"]) ? $context["sAreaId"] : null), "html", null, true);
            ...
            echo "') {
                ...
                ";
            // line 286
            if (((isset($context["sDataLoading"]) ? $context["sDataLoading"] : null) == twig_constant("Combodo\\iTop\\Portal\\Brick\\AbstractBrick::ENUM_DATA_LOADING_FULL"))) {
                // line 287
                echo "                \"data\": rawData['";
                echo twig_escape_filter($this->env, (isset($context["sAreaId"]) ? $context["sAreaId"] : null), "html", null, true);
                echo "'],
...
\t\t\t\t\t\"url\": \"";
                // line 293
                echo $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "url_generator", array()), "generate", array(0 => "p_manage_brick_lazy", 1 => array("sBrickId" => (isset($context["sBrickId"]) ? $context["sBrickId"] : null), "sGroupingTab" => (isset($context["sGroupingTab"]) ? $context["sGroupingTab"] : null), "sGroupingArea" => (isset($context["sAreaId"]) ? $context["sAreaId"] : null))), "method");
                echo "\",
                    \"data\": function (d) {
                        ...
                        ";
                // line 300
                if ( !(null === (isset($context["sSearchValue"]) ? $context["sSearchValue"] : null))) {
                    // line 301
                    ...
                    echo twig_escape_filter($this->env, (isset($context["sSearchValue"]) ? $context["sSearchValue"] : null), "html", null, true);
                    echo "');
...
";
    ...
    {
        return new Twig_Source("", "itop-portal-base/portal/src/views/bricks/manage/layout-table.html.twig", "C:\\wamp64\\www\\itop3\\env-production\\itop-portal-base\\portal\\src\\views\\bricks\\manage\\layout-table.html.twig");
    }
}
