...
class __TwigTemplate_8676459aeebd1296c4cb4daca42cf4a5674e0d54a009bca1e2b4f43d0b80c20b extends Twig_Template
{
...
";
    ...
    public function block_pMainHeaderActions($context, array $blocks = array())
    {
        // line 12
        echo "\t";
        if ((twig_length_filter($this->env, (isset($context["aBrowseButtons"]) ? $context["aBrowseButtons"] : null)) > 1)) {
            // line 13
...
\t\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["aBrowseButtons"]) ? $context["aBrowseButtons"] : null));
            foreach ($context['_seq'] as $context["_key"] => $context["sBrowseButton"]) {
                // line 15
                echo "\t\t\t<a href=\"";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "url_generator", array()), "generate", array(0 => "p_browse_brick_mode", 1 => array("sBrickId" => (isset($context["sBrickId"]) ? $context["sBrickId"] : null), "sBrowseMode" => $context["sBrowseButton"])), "method"), "html", null, true);
                echo "\" class=\"btn btn-default ";
                if (((isset($context["sBrowseMode"]) ? $context["sBrowseMode"] : null) == $context["sBrowseButton"])) {
                    echo "active";
                }
                echo "\">";
...
\t";
    ...
    public function block_pMainContentHolder($context, array $blocks = array())
    {
        // line 22
        echo "\t";
        if ((((isset($context["iItemsCount"]) ? $context["iItemsCount"] : null) > 0) ||  !(null === (isset($context["sSearchValue"]) ? $context["sSearchValue"] : null)))) {
            // line 23
...
\t";
    ...
    {
        return new Twig_Source("", "itop-portal-base/portal/src/views/bricks/browse/layout.html.twig", "C:\\wamp64\\www\\itop3\\env-production\\itop-portal-base\\portal\\src\\views\\bricks\\browse\\layout.html.twig");
    }
}
