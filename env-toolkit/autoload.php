<?php
//
// File generated on 2018-09-23T22:46:53+0200
...
MetaModel::IncludeModule(MODULESROOT.'/sample-add-class-router/model.sample-add-class-router.php');
MetaModel::IncludeModule(MODULESROOT.'/sample-add-class-switch/model.sample-add-class-switch.php');
MetaModel::IncludeModule(MODULESROOT.'/sample-delete-attribute/model.sample-delete-attribute.php');
...
MetaModel::IncludeModule(MODULESROOT.'/sample-delete-feillduser/model.sample-delete-feillduser.php');
...
return array (
  ...
  'sample-add-class-router' => 
  array (
    'root_dir' => $sCurrEnv.'/sample-add-class-router',
    'version' => '1.0.0',
  ),
  'sample-add-class-switch' => 
  array (
    'root_dir' => $sCurrEnv.'/sample-add-class-switch',
    'version' => '1.0.0',
  ),
  'sample-delete-attribute' => 
  array (
    'root_dir' => $sCurrEnv.'/sample-delete-attribute',
    'version' => '1.0.0',
  ),
  ...
  'sample-delete-feilldUser' => 
  array (
    'root_dir' => $sCurrEnv.'/sample-delete-feillduser',
    'version' => '1.0.0',
  ),
);
}
